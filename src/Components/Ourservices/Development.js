...
import {  Data2,StrategyHeadData,StrategyData } from './DataJson';
        ...
        <React.Fragment>
            ...
            <Container className="mt-4 mb-4">
                ...
                <Row >
                    ...
                    <Col md="6" style={{backgroundColor:"rgb(238, 241, 241)",fontSize:"46px",fontWeight:"580"}} className="mt-5 text-center " >
                   Other Services
                    </Col>
                    <Col md="3">
                    </Col>
